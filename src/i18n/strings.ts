...
export const STRINGS = {
  zh: {
    ...
    "methods.title": "问题分类",
    "methods.subtitle": "全部 433 条 bug 按问题类型的分布。点任一类可跳到对应案例。",
    "methods.col_count": "条",
    ...
    "about.zh_para1": "独立 Minecraft mod 测试。主要做多轮回归、多语言验证和跨 mod 兼容性测试。版本不锁, 已测 mod 覆盖 MC 1.14 → 1.21。",
    "about.zh_para2": "测试报告以中文撰写, 涵盖崩溃、机制、生物行为、配方、规格对照、本地化、跨 mod 兼容等问题。每条记录写清楚可复现的现象, 并标注版本与测试轮次。",
  ...
  en: {
    ...
    "methods.title": "Bug categories",
    "methods.subtitle": "All 433 bugs grouped by problem type. Click any category to jump to its cases.",
    ...
    "about.role": "Minecraft mod tester",
    "about.greeting": "LUCK666DUCK",
    "about.zh_para1": "Independent Minecraft mod tester. Multi-round regression, multi-locale verification, and cross-mod compatibility testing. Version-agnostic — tested mods span MC 1.14 → 1.21.",
