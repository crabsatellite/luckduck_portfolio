...
export const STRINGS = {
  zh: {
    ...
    "hero.role": "我做 Minecraft mod 测试, 主要是洗澡 / 卫浴类的 mod, 在 1.20.1 与 1.21.1 上跑测试。简体 / 繁中 / 日文 / English 都能写报告。",
    ...
    "about.zh_para1": "我是独立 Minecraft mod 测试员。专注于多轮回归测试、多语言场景验证以及跨 mod 兼容性取证。当前主要在 1.20.1 与 1.21.1 上展开测试工作。",
  ...
  en: {
    ...
    "hero.greeting_en": "Hi, I'm Tingfeng — LUCK666DUCK.",
    "hero.greeting_zh": "嗨, 我是楊庭鳳。",
    "hero.role": "I test Minecraft mods, mostly hygiene & bath ones, on 1.20.1 and 1.21.1. I write reports in 简体 / 繁中 / 日本語 / English.",
    ...
    "about.zh_para1": "Independent Minecraft mod tester. Focus on multi-round regression, multi-locale verification, and cross-mod compatibility forensics. Currently active on 1.20.1 and 1.21.1.",
